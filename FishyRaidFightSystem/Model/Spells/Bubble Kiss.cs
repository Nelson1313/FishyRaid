...
namespace FishyRaidFightSystem.Model.Spells
{
    ...
    public class BubbleKiss : Spell
    {
        ...
        public override void Tamad(Fish mit, ObservableCollection<Fish> halak)
        {
            ...
            Hala.lovedeke.eleres = System.IO.Path.Combine(Directory.GetParent(System.IO.Directory.GetCurrentDirectory()).Parent.Parent.Parent.Parent.Parent.FullName + "/Images", "bubblekiss.png");
            Hala.elfoglalt = true;
            Task elso = new Task(() =>
            {
        ...
        public void Csinal(Fish mit)
        {
            ...
            Task t = new Task(() =>
            {
                ...
                if (krite != 2)
                {
                    mit.Elet -= R.Next((Hala.Ero / 3) * 2, (Hala.Ero / 2) * 2);
                }
                else
                {
                    mit.Elet -= R.Next(2 * (Hala.Ero / 3) * 2, 2 * (Hala.Ero / 2) * 2);
                }
